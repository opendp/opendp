...
- [`new_function()`](https://docs.opendp.org/reference/new_function.md)
  : Construct a Function from a user-defined callback. Can be used to
  build a postprocessor.
...
- [`user_domain()`](https://docs.opendp.org/reference/user_domain.md) :
  Construct a new UserDomain. Any two instances of an UserDomain are
  equal if their string descriptors are equal. Contains a function used
  to check if any value is a member of the domain.
...
- [`then_user_measurement()`](https://docs.opendp.org/reference/then_user_measurement.md)
...
- [`user_distance()`](https://docs.opendp.org/reference/user_distance.md)
  : Construct a new UserDistance. Any two instances of an UserDistance
  are equal if their string descriptors are equal.
...
- [`new_function_internal()`](https://docs.opendp.org/reference/new_function_internal.md)
  : new function
...
- [`new_odometer_queryable_internal()`](https://docs.opendp.org/reference/new_odometer_queryable_internal.md)
  : new odometer queryable

- [`new_privacy_profile_internal()`](https://docs.opendp.org/reference/new_privacy_profile_internal.md)
  : new privacy profile

- [`new_queryable_internal()`](https://docs.opendp.org/reference/new_queryable_internal.md)
  : new queryable
...
- [`then_user_transformation()`](https://docs.opendp.org/reference/then_user_transformation.md)
...
- [`ExtrinsicObject`](https://docs.opendp.org/reference/ExtrinsicObject.md)
...
- [`parse_or_infer()`](https://docs.opendp.org/reference/parse_or_infer.md)
  : Parse a runtime type or infer it from an example
- [`rt_infer()`](https://docs.opendp.org/reference/rt_infer.md) : Infer
  a runtime type from a public example
- [`rt_parse()`](https://docs.opendp.org/reference/rt_parse.md) : Parse
  a runtime type descriptor into a runtime_type object
...
- [`then_postprocess()`](https://docs.opendp.org/reference/then_postprocess.md)
  : Compose a measurement with a postprocessing function.

- [`to_then()`](https://docs.opendp.org/reference/to_then.md) :
