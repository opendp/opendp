...
documentation.](https://docs.rs/opendp/0.15.1/opendp/measurements/fn.make_randomized_response_bool.html)

**Citations:**

- [Warner65 Randomized Response: A Survey Technique for Eliminating
  Evasive Answer Bias](https://doi.org/10.1080/01621459.1965.10480775)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/measurements/randomized_response/make_randomized_response_bool.pdf)
