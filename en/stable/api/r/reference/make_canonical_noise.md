...
documentation.](https://docs.rs/opendp/0.15.1/opendp/measurements/fn.make_canonical_noise.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/measurements/canonical_noise/make_canonical_noise.pdf)
