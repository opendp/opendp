...
documentation.](https://docs.rs/opendp/0.14.2/opendp/measurements/fn.make_canonical_noise.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.14.2/proofs/rust/src/measurements/canonical_noise/make_canonical_noise.pdf)
