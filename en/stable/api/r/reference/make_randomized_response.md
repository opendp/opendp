...
documentation.](https://docs.rs/opendp/0.14.2/opendp/measurements/fn.make_randomized_response.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.14.2/proofs/rust/src/measurements/randomized_response/make_randomized_response.pdf)
