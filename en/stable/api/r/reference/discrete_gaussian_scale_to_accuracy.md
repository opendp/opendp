...
documentation.](https://docs.rs/opendp/0.14.2/opendp/accuracy/fn.discrete_gaussian_scale_to_accuracy.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.14.2/proofs/rust/src/accuracy/discrete_gaussian_scale_to_accuracy.pdf)
