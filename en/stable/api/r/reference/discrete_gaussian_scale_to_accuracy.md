...
documentation.](https://docs.rs/opendp/0.15.1/opendp/accuracy/fn.discrete_gaussian_scale_to_accuracy.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/accuracy/discrete_gaussian_scale_to_accuracy.pdf)
