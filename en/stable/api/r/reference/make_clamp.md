...
[make_clamp in Rust
documentation.](https://docs.rs/opendp/0.15.1/opendp/transformations/fn.make_clamp.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/transformations/clamp/make_clamp.pdf)
