...
documentation.](https://docs.rs/opendp/0.15.1/opendp/combinators/fn.make_fully_adaptive_composition.html)

**Citations:**

- [WRRW23 Fully Adaptive Composition in Differential
  Privacy](https://arxiv.org/abs/2203.05481)

- [VZ23 Concurrent Composition Theorems for Differential
  Privacy](http://dx.doi.org/10.1145/3564246.3585241)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/combinators/sequential_composition/fully_adaptive/make_fully_adaptive_composition.pdf)
