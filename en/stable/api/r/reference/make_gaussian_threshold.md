...
documentation.](https://docs.rs/opendp/0.14.2/opendp/measurements/fn.make_gaussian_threshold.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.14.2/proofs/rust/src/measurements/noise_threshold/distribution/gaussian/make_gaussian_threshold.pdf)
