...
documentation.](https://docs.rs/opendp/0.15.1/opendp/measurements/fn.make_gaussian_threshold.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/measurements/noise_threshold/distribution/gaussian/make_gaussian_threshold.pdf)
