...
Make a Transformation that computes the sum of bounded data with known
dataset size.
...
dataset size for better utility. Use `make_clamp` to bound data and
`make_resize` to establish dataset size.
...
[make_bounded_float_checked_sum in Rust
documentation.](https://docs.rs/opendp/0.14.1/opendp/transformations/fn.make_bounded_float_checked_sum.html)
