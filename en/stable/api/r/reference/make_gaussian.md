...
documentation.](https://docs.rs/opendp/0.15.1/opendp/measurements/fn.make_gaussian.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/measurements/noise/distribution/gaussian/make_gaussian.pdf)
...
gaussian <- make_gaussian(
  ...
  scale = 1.0)
#> Error in .Call("domains__atom_domain", bounds, nan, .T, .T.bounds, .T.nan,     log_, PACKAGE = "opendp"): "domains__atom_domain" not available for .Call() for package "opendp"
gaussian(arg = 100.0)
