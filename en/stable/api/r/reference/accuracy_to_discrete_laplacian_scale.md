...
documentation.](https://docs.rs/opendp/0.15.1/opendp/accuracy/fn.accuracy_to_discrete_laplacian_scale.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/accuracy/accuracy_to_discrete_laplacian_scale.pdf)
