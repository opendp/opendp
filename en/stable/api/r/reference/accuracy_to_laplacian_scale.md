...
[accuracy_to_laplacian_scale in Rust
documentation.](https://docs.rs/opendp/0.14.1/opendp/accuracy/fn.accuracy_to_laplacian_scale.html)
...
Laplacian noise scale that meets the `accuracy` requirement at a given
level-`alpha`.
