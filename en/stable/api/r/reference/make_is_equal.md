...
documentation.](https://docs.rs/opendp/0.14.2/opendp/transformations/fn.make_is_equal.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.14.2/proofs/rust/src/transformations/manipulation/make_is_equal.pdf)
