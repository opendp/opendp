...
documentation.](https://docs.rs/opendp/0.15.1/opendp/transformations/fn.make_is_equal.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/transformations/manipulation/make_is_equal.pdf)
