...
documentation.](https://docs.rs/opendp/0.15.1/opendp/accuracy/fn.discrete_laplacian_scale_to_accuracy.html)

**Proof Definition:**

[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/accuracy/discrete_laplacian_scale_to_accuracy.pdf)
