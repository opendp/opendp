...
documentation.](https://docs.rs/opendp/0.15.1/opendp/measurements/fn.make_laplace.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.15.1/proofs/rust/src/measurements/noise/distribution/laplace/make_laplace.pdf)
