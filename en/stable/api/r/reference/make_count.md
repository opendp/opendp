...
[make_count in Rust
documentation.](https://docs.rs/opendp/0.14.2/opendp/transformations/fn.make_count.html)
...
[(Proof
Document)](https://docs.opendp.org/en/v0.14.2/proofs/rust/src/transformations/count/make_count.pdf)
