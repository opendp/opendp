...
def main():
    ...
    parse_column_1 = odp.trans.make_parse_column(b"<i32, i32, HammingDistance>", odp.i32_p(1), True)
    parse_column_2 = odp.trans.make_parse_column(b"<i32, f64, HammingDistance>", odp.i32_p(2), True)
    parse_dataframe = odp.make_chain_tt_multi(parse_column_2, parse_column_1, split_dataframe)

    # Noisy sum, col 1
    select_1 = odp.trans.make_select_column(b"<i32, i32, HammingDistance>", odp.i32_p(1))
    clamp_1 = odp.trans.make_clamp(b"<i32, HammingDistance>", odp.i32_p(0), odp.i32_p(10))
    bounded_sum_1 = odp.trans.make_bounded_sum(b"<i32, HammingDistance, L1Sensitivity<i32>>", odp.i32_p(0), odp.i32_p(10))
    ...
    # Count, col 1
    select_2 = odp.trans.make_select_column(b"<i32, f64, HammingDistance>", odp.i32_p(2))
