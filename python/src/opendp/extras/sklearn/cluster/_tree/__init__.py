...
def make_private_tree(
    ...
    *,
    ...
    children = make_private_children(
        split.output_domain,
        split.output_metric,
        output_measure,
        splitter=splitter,
...
def make_private_children(
    ...
    *,
    ...
    child_splitters = _child_splitters(splitter, depth - 1)
    ...
    m_recurse = [
        make_private_tree(
            input_domain.element_domain,
            input_metric.descriptor,
            output_measure,
