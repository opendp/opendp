...
class Margin:
    ...
    * ``"lengths"`` designates that both keys and partition lengths are not protected
    ...
    @property
    @deprecated(reason="Use max_length instead. This was renamed to be consistent with Polars terminology.")
    ...
    def max_partition_contributions(self):
        raise NotImplementedError("max_partition_contributions is deprecated. Use `dp.unit_of(contributions=[dp.polars.Bound(per_group=...)])` instead.")
    ...
    def max_influenced_partitions(self):
        raise NotImplementedError("max_influenced_partitions is deprecated. Use `dp.unit_of(contributions=[dp.polars.Bound(num_groups=...)])` instead.")
