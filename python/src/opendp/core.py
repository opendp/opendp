...
def odometer_function(
    ...
    r"""Get the function from a odometer.
...
def odometer_queryable_invoke(
    ...
    r"""Eval the odometer `queryable` with an invoke `query`. Returns a differentially private release.
...
def odometer_queryable_map(
    ...
    r"""Eval the odometer `queryable` with a map `query`. Returns the current d_out.
...
def queryable_query_odometer_invoke_type(
    ...
    r"""Get the query odometer invoke type of `queryable`.
...
def queryable_query_odometer_map_type(
    ...
    r"""Get the query odometer map type of `queryable`.
