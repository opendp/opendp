...
def new_user_queryable(
    ...
    [new_user_queryable in Rust documentation.](https://docs.rs/opendp/latest/opendp/combinators/fn.new_user_queryable.html)
    ...
    # Call library function.
    lib_function = lib.opendp_combinators__new_user_queryable
