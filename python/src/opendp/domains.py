...
def _lazyframe_from_domain(
    ...
    [_lazyframe_from_domain in Rust documentation.](https://docs.rs/opendp/0.11.0-nightly.20240812.1/opendp/domains/fn._lazyframe_from_domain.html)
...
def series_domain(
    ...
    [series_domain in Rust documentation.](https://docs.rs/opendp/0.11.0-nightly.20240812.1/opendp/domains/fn.series_domain.html)
