...
def _lazyframe_from_domain(
    ...
    [_lazyframe_from_domain in Rust documentation.](https://docs.rs/opendp/0.11.1-dev.20241008.1/opendp/domains/fn._lazyframe_from_domain.html)
...
def atom_domain(
    ...
    [atom_domain in Rust documentation.](https://docs.rs/opendp/0.11.1-dev.20241008.1/opendp/domains/fn.atom_domain.html)
...
def option_domain(
    ...
    [option_domain in Rust documentation.](https://docs.rs/opendp/0.11.1-dev.20241008.1/opendp/domains/fn.option_domain.html)
...
def series_domain(
    ...
    [series_domain in Rust documentation.](https://docs.rs/opendp/0.11.1-dev.20241008.1/opendp/domains/fn.series_domain.html)
