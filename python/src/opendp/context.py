...
def unit_of(
    *,
    contributions: Optional[Union[int, Sequence[GroupBound]]] = None,
    ...
    ordered: bool = False,
    U=None,
) -> tuple[Metric, Union[float, Sequence[GroupBound]]]:
...
class Context(object):
    ...
    def __init__(
        ...
        queryable: Queryable,
        d_in: Union[float, Sequence[GroupBound]],
    ...
    def compositor(
        data: Any,
        privacy_unit: tuple[Metric, Union[float, Sequence[GroupBound]]],
        ...
        if margins:
            ...
            for margin in margins:
                if margin.max_influenced_partitions is not None or margin.max_partition_contributions is not None:
                    raise ValueError("'max_influenced_partitions' and 'max_partition_contributions' have been moved to the 'privacy_unit' kwarg. Try `dp.unit_of(contributions=[dp.polars.GroupBound(max_*=)])` instead.")
...
class Query(object):
    ...
    def __init__(
        ...
        d_in: Optional[Union[float, Sequence[GroupBound]]] = None,
        d_out: Optional[float] = None,
...
class PartialChain(object):
    ...
    def fix(self, d_in: Union[float, Sequence[GroupBound]], d_out: float, output_measure: Optional[Measure] = None, T=None):
