...
class OdometerQueryable(object):
    ...
    '''
    def __init__(self, value, invoke_type):
        self.value = value
    ...
    def privacy_loss(self):
        ...
        return odometer_queryable_privacy_loss(self.value)

    def __repr__(self) -> str:
        return f"OdometerQueryable(Q={self.invoke_type})"
