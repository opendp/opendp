...
def make_scan_csv(
    ...
    * Output Metric:  `M`
    ...
    lib_function.argtypes = [Domain, Metric, ctypes.c_char, ctypes.c_bool, ctypes.c_bool, ctypes.c_size_t, ctypes.c_bool, ctypes.c_bool, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_char, AnyObjectPtr, ctypes.c_bool, ctypes.c_bool, ctypes.c_size_t, ctypes.c_bool, ctypes.c_char_p]
    lib_function.restype = FfiResult
...
def make_sized_partitioned_sum(
    ...
    [make_sized_partitioned_sum in Rust documentation.](https://docs.rs/opendp/latest/opendp/transformations/fn.make_sized_partitioned_sum.html)
    ...
    * Output Metric:  `L1Distance<T>`
    ...
    :param T: Type of bounds for clamping.
    :type T: :py:ref:`RuntimeTypeDescriptor`
    :rtype: Transformation
    :raises TypeError: if an argument's type differs from the expected type
    :raises UnknownTypeError: if a type argument fails to parse
