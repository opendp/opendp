...
def fixed_smoothed_max_divergence(
    ...
    [fixed_smoothed_max_divergence in Rust documentation.](https://docs.rs/opendp/0.10.0-nightly.20240805.1/opendp/measures/fn.fixed_smoothed_max_divergence.html)
...
def max_divergence(
    ...
    [max_divergence in Rust documentation.](https://docs.rs/opendp/0.10.0-nightly.20240805.1/opendp/measures/fn.max_divergence.html)
...
def smoothed_max_divergence(
    ...
    [smoothed_max_divergence in Rust documentation.](https://docs.rs/opendp/0.10.0-nightly.20240805.1/opendp/measures/fn.smoothed_max_divergence.html)
...
def zero_concentrated_divergence(
    ...
    [zero_concentrated_divergence in Rust documentation.](https://docs.rs/opendp/0.10.0-nightly.20240805.1/opendp/measures/fn.zero_concentrated_divergence.html)
