...
make_basic_composition <- function(...){
  ...
  retval <- .Call("odp_make_basic_composition", measVec, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}
...
make_chain_mt <- function(meas, tran) {
  ...
  retval <- .Call("odp_make_chain_mt", meas$MeasurementPtr, tran$TransformationPtr, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}
...
make_chain_tm <- function(tran, meas) {
  ...
  retval <- .Call("odp_make_chain_tm",  tran$TransformationPtr, meas$MeasurementPtr, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}

make_chain_tt <- function(tran1, tran2) {
  info <- list(name="make_chain_tt", tran1=getInfo(tran1), tran2=getInfo(tran2))
  retval <- .Call("odp_make_chain_tt",  tran1$TransformationPtr, tran2$TransformationPtr, info, PACKAGE = 'opendpbase')
  returnTran(retval)
}
...
make_population_amplification <- function(meas, population_size) {
  ...
  retval <- .Call("odp_make_population_amplification", meas$MeasurementPtr, population_size, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}

make_pureDP_to_fixed_approxDP <- function(meas) {
  info <- list(name="make_pureDP_to_fixed_approxDP", meas=meas)
  retval <- .Call("odp_make_pureDP_to_fixed_approxDP",  meas$MeasurementPtr, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}
...
make_pureDP_to_zCDP <- function(meas) {
  ...
  retval <- .Call("odp_make_pureDP_to_zCDP",  meas$MeasurementPtr, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}

make_zCDP_to_approxDP <- function(meas) {
  info <- list(name="make_zCDP_to_approxDP", meas=meas)
  retval <- .Call("odp_make_zCDP_to_approxDP",  meas$MeasurementPtr, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}

make_fix_delta <- function(meas, delta) {
  info <- list(name="make_fix_delta", meas=meas, delta=delta)
  retval <- .Call("odp_make_fix_delta",  meas$MeasurementPtr, delta, info, PACKAGE = 'opendpbase')
  returnMeas(retval)
}
