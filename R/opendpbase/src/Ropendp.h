...
SEXP data__extrinsic_object_free(SEXP this, SEXP log);
SEXP data__fill_bytes(SEXP ptr, SEXP len, SEXP log);
...
SEXP domains___user_domain_descriptor(SEXP domain, SEXP log);
...
SEXP domains__user_domain(SEXP identifier, SEXP member, SEXP descriptor, SEXP log);
...
SEXP measurements__make_base_discrete_laplace(SEXP input_domain, SEXP input_metric, SEXP scale, SEXP QO, SEXP log);
SEXP measurements__make_base_discrete_laplace_cks20(SEXP input_domain, SEXP input_metric, SEXP scale, SEXP QO, SEXP log);
SEXP measurements__make_base_discrete_laplace_linear(SEXP input_domain, SEXP input_metric, SEXP scale, SEXP bounds, SEXP QO, SEXP T, SEXP OptionT, SEXP log);
