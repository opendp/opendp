...
typedef struct CallbackFn {
  struct FfiResult_____AnyObject *(*callback)(const struct AnyObject*, const void*);
  struct ExtrinsicObject userdata;
} CallbackFn;
...
typedef struct TransitionFn {
  struct FfiResult_____AnyObject *(*callback)(const struct AnyObject*, c_bool, const void*);
  struct ExtrinsicObject userdata;
} TransitionFn;
...
struct FfiResult_____AnyFunction opendp_core__as_array(void);
 ...
 */
struct FfiResult_____AnyMeasure opendp_internal___extrinsic_divergence(char *identifier,
                                                                       struct ExtrinsicObject *descriptor);
...
struct FfiResult_____AnyObject opendp_internal___binary_search(const struct CallbackFn *predicate,
                                                               const struct AnyObject *bounds,
                                                               bool return_sign,
                                                               const char *T);

struct FfiResult_____AnyObject opendp_internal___exponential_bounds_search(const struct CallbackFn *predicate,
                                                                           const char *T);
 ...
 */
struct FfiResult_____AnyMeasure opendp_measures__user_divergence(char *identifier,
                                                                 struct ExtrinsicObject *descriptor);
 ...
 */
struct FfiResult_____ExtrinsicObject opendp_measures___extrinsic_measure_descriptor(struct AnyMeasure *measure);
