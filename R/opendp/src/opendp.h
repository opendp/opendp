 ...
 */
struct FfiResult_____AnyObject opendp_core__odometer_queryable_invoke_measurement(struct AnyObject *queryable,
 ...
 * * `query` - Invoke query to supply to the queryable.
 */
struct FfiResult_____AnyObject opendp_core__odometer_queryable_invoke_odometer(struct AnyObject *queryable,
                                                                               const AnyOdometer *odometer);
