...
struct FfiResult_____AnyMeasurement opendp_measurements__make_base_discrete_exponential(const struct AnyDomain *input_domain,
                                                                                        const struct AnyMetric *input_metric,
                                                                                        const struct AnyObject *temperature,
                                                                                        const char *optimize,
                                                                                        const char *QO);
...
struct FfiResult_____AnyMetric opendp_metrics__linf_diff_distance(const char *T);
