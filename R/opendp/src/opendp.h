...
struct FfiResult_____AnyMeasurement opendp_measurements__make_rappor(const struct AnyDomain *input_domain,
                                                                     const struct AnyMetric *input_metric,
                                                                     double f,
                                                                     c_bool constant_time);

struct FfiResult_____AnyObject opendp_measurements__debias_basic_rappor(const struct AnyObject *answers,
                                                                        double f);
