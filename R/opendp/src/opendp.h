...
struct FfiResult_____AnyDomain opendp_domains__with_margin(struct AnyDomain *frame_domain,
                                                           struct AnyObject *by,
                                                           void *max_partition_length,
                                                           void *max_num_partitions,
                                                           void *max_partition_contributions,
                                                           void *max_influenced_partitions,
                                                           char *public_info);
...
struct FfiResult_____AnyDomain opendp_domains__wild_expr_domain(const struct AnyObject *columns,
                                                                ...
                                                                const void *max_partition_length,
                                                                const void *max_num_partitions,
                                                                const void *max_partition_contributions,
                                                                const void *max_influenced_partitions,
 ...
 */
struct FfiResult_____AnyMetric opendp_internal___extrinsic_distance(char *descriptor);
