...
SEXP measurements__debias_basic_rappor(
    ...
    FfiResult_____AnyObject _result = opendp_measurements__debias_basic_rappor(c_answers, c_f);
...
SEXP measurements__make_rappor(
    ...
    // Call library function.
    FfiResult_____AnyMeasurement _result = opendp_measurements__make_rappor(c_input_domain, c_input_metric, c_f, c_constant_time);
