...
SEXP metrics___extrinsic_metric_descriptor(
    ...
    FfiResult_____ExtrinsicObject _result = opendp_metrics___extrinsic_metric_descriptor(c_metric);
...
SEXP metrics__user_distance(
    ...
    // Call library function.
    FfiResult_____AnyMetric _result = opendp_metrics__user_distance(c_identifier, c_descriptor);
