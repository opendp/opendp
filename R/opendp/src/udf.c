...
static FfiResult_____AnyObject *wrap_callback_failure(
    const char *error_context,
    const char *message)
{
    char *variant = error_variant_from_message(message);
    FfiResult_____AnyObject *result = wrap_failure_details(variant, message, error_context);
    free(variant);
    return result;
}
    ...
    const char *error_context)
{
    ...
    {
        char *message = get_last_error_message();
        FfiResult_____AnyObject *result = wrap_callback_failure(error_context, message);
        free(message);
        return result;
    }
    ...
    {
        FfiResult_____AnyObject *result = wrap_callback_failure(error_context, conversion.message);
