...
SEXP combinators__make_basic_composition(
    ...
    FfiSlice * c_measurements = "UNKNOWN TYPE: FfiSlice *";
...
SEXP combinators__make_sequential_odometer(
    SEXP input_domain, SEXP input_metric, SEXP output_measure, SEXP Q, SEXP log
) {
    // Convert arguments to c types.
    PROTECT(input_domain);
    PROTECT(input_metric);
    ...
    // Call library function.
    FfiResult_____AnyOdometer _result = opendp_combinators__make_sequential_odometer(c_input_domain, c_input_metric, c_output_measure, c_Q);
