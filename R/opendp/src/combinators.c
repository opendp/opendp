...
SEXP combinators__make_basic_composition(
    ...
    FfiSlice * c_measurements = sexp_to_ffisliceptr(measurements, T_measurements);
...
SEXP combinators__make_chain_ot(
    SEXP odometer1, SEXP transformation0, SEXP log
) {
    // Convert arguments to c types.
    PROTECT(odometer1);
    PROTECT(transformation0);
    ...
    AnyOdometer * c_odometer1 = "UNKNOWN TYPE: AnyOdometer *";
    AnyTransformation * c_transformation0 = sexp_to_anytransformationptr(transformation0);

    // Call library function.
    FfiResult_____AnyOdometer _result = opendp_combinators__make_chain_ot(c_odometer1, c_transformation0);

    UNPROTECT(3);
    if(_result.tag == Err_____AnyOdometer)
        return(extract_error(_result.err));
    AnyOdometer* _return_value = _result.ok;
    return("UNKNOWN RET TYPE: AnyOdometer *");
}
...
SEXP combinators__make_chain_po(
    SEXP function1, SEXP odometer0, SEXP log
) {
    // Convert arguments to c types.
    PROTECT(function1);
    PROTECT(odometer0);
    ...
    AnyFunction * c_function1 = sexp_to_anyfunctionptr(function1);
    AnyOdometer * c_odometer0 = "UNKNOWN TYPE: AnyOdometer *";

    // Call library function.
    FfiResult_____AnyOdometer _result = opendp_combinators__make_chain_po(c_function1, c_odometer0);
...
SEXP combinators__make_sequential_odometer(
    ...
    // Call library function.
    FfiResult_____AnyOdometer _result = opendp_combinators__make_sequential_odometer(c_input_domain, c_input_metric, c_output_measure);
