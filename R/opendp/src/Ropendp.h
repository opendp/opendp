...
SEXP core__new_function(SEXP function, SEXP TO, SEXP T_function, SEXP log);
SEXP core__new_queryable(SEXP transition, SEXP Q, SEXP A, SEXP T_transition, SEXP log);
...
SEXP domains___extrinsic_domain_descriptor(SEXP domain, SEXP log);
...
SEXP domains__user_domain(SEXP identifier, SEXP member, SEXP descriptor, SEXP T_member, SEXP log);
SEXP domains__vector_domain(SEXP atom_domain, SEXP size, SEXP T_size, SEXP log);
SEXP internal___binary_search(SEXP predicate, SEXP lower, SEXP upper, SEXP return_sign, SEXP T, SEXP T_predicate, SEXP T_lower, SEXP T_upper, SEXP log);
SEXP internal___exponential_bounds_search(SEXP predicate, SEXP T, SEXP T_predicate, SEXP log);
SEXP internal___extrinsic_distance(SEXP identifier, SEXP descriptor, SEXP log);
SEXP internal___extrinsic_divergence(SEXP identifier, SEXP descriptor, SEXP log);
SEXP internal___extrinsic_domain(SEXP identifier, SEXP member, SEXP descriptor, SEXP T_member, SEXP log);
SEXP internal___make_measurement(SEXP input_domain, SEXP input_metric, SEXP output_measure, SEXP function, SEXP privacy_map, SEXP TO, SEXP T_function, SEXP T_privacy_map, SEXP log);
SEXP internal___make_transformation(SEXP input_domain, SEXP input_metric, SEXP output_domain, SEXP output_metric, SEXP function, SEXP stability_map, SEXP T_function, SEXP T_stability_map, SEXP log);
SEXP internal___new_pure_function(SEXP function, SEXP TO, SEXP T_function, SEXP log);
...
SEXP measurements__make_user_measurement(SEXP input_domain, SEXP input_metric, SEXP output_measure, SEXP function, SEXP privacy_map, SEXP TO, SEXP T_function, SEXP T_privacy_map, SEXP log);
SEXP measures___approximate_divergence_get_inner_measure(SEXP privacy_measure, SEXP log);
SEXP measures___extrinsic_measure_descriptor(SEXP measure, SEXP log);
...
SEXP measures__new_privacy_profile(SEXP curve, SEXP T_curve, SEXP log);
SEXP measures__renyi_divergence(SEXP log);
SEXP measures__smoothed_max_divergence(SEXP log);
SEXP measures__user_divergence(SEXP identifier, SEXP descriptor, SEXP log);
SEXP measures__zero_concentrated_divergence(SEXP log);
SEXP metrics___extrinsic_metric_descriptor(SEXP metric, SEXP log);
...
SEXP metrics__user_distance(SEXP identifier, SEXP descriptor, SEXP log);
...
SEXP transformations__make_user_transformation(SEXP input_domain, SEXP input_metric, SEXP output_domain, SEXP output_metric, SEXP function, SEXP stability_map, SEXP T_function, SEXP T_stability_map, SEXP log);
