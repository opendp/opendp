...
SEXP domains___atom_domain_get_nullable(SEXP domain, SEXP log);
...
SEXP measurements__make_private_quantile(SEXP input_domain, SEXP input_metric, SEXP candidates, SEXP alpha, SEXP scale, SEXP T, SEXP T_candidates, SEXP log);
