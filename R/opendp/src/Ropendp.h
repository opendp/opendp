...
SEXP combinators__make_sequential_odometer(SEXP input_domain, SEXP input_metric, SEXP output_measure, SEXP log);
...
SEXP core__odometer_queryable_invoke(SEXP queryable, SEXP query, SEXP log);
