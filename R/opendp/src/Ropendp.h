...
SEXP measurements__make_private_select(SEXP input_domain, SEXP input_metric, SEXP measurement, SEXP log);
SEXP measurements__make_private_sum_expr(SEXP input_domain, SEXP input_metric, SEXP scale, SEXP QO, SEXP log);
