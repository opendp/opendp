...
SEXP measurements__debias_basic_rappor(SEXP answers, SEXP f, SEXP T_answers, SEXP log);
...
SEXP measurements__make_rappor(SEXP input_domain, SEXP input_metric, SEXP f, SEXP constant_time, SEXP log);
