...
SEXP combinators__make_chain_ot(SEXP odometer1, SEXP transformation0, SEXP log);
SEXP combinators__make_chain_pm(SEXP postprocess1, SEXP measurement0, SEXP log);
SEXP combinators__make_chain_po(SEXP function1, SEXP odometer0, SEXP log);
...
SEXP combinators__make_sequential_odometer(SEXP input_domain, SEXP input_metric, SEXP output_measure, SEXP Q, SEXP log);
...
SEXP core__odometer_function(SEXP this, SEXP log);
...
SEXP core__odometer_queryable_map(SEXP queryable, SEXP query, SEXP T_query, SEXP log);
SEXP core__queryable_eval(SEXP queryable, SEXP query, SEXP T_query, SEXP log);
SEXP core__queryable_query_odometer_invoke_type(SEXP this, SEXP log);
SEXP core__queryable_query_odometer_map_type(SEXP this, SEXP log);
...
SEXP data__smd_curve_epsilon(SEXP curve, SEXP delta, SEXP log);
