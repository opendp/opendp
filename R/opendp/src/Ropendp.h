...
SEXP measurements__make_base_discrete_exponential(SEXP input_domain, SEXP input_metric, SEXP temperature, SEXP optimize, SEXP QO, SEXP log);
...
SEXP metrics__linf_diff_distance(SEXP T, SEXP log);
