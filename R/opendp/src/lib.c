...
static R_CMethodDef R_CDef[] = {
    ...
    {"domains__csv_domain", (DL_FUNC) &domains__csv_domain, 8},
    ...
    {"measurements__make_laplace_expr", (DL_FUNC) &measurements__make_laplace_expr, 6},
    ...
    {"measurements__make_private_sum_expr", (DL_FUNC) &measurements__make_private_sum_expr, 5},
    ...
    {"measurements__make_report_noisy_max_gumbel_expr", (DL_FUNC) &measurements__make_report_noisy_max_gumbel_expr, 8},
    ...
    {"transformations__make_lazy", (DL_FUNC) &transformations__make_lazy, 3},
