...
static R_CMethodDef R_CDef[] = {
    ...
    {"combinators__make_chain_ot", (DL_FUNC) &combinators__make_chain_ot, 3},
    {"combinators__make_chain_pm", (DL_FUNC) &combinators__make_chain_pm, 3},
    {"combinators__make_chain_po", (DL_FUNC) &combinators__make_chain_po, 3},
    ...
    {"combinators__make_sequential_odometer", (DL_FUNC) &combinators__make_sequential_odometer, 5},
    ...
    {"core__odometer_function", (DL_FUNC) &core__odometer_function, 2},
    {"core__odometer_input_domain", (DL_FUNC) &core__odometer_input_domain, 2},
    {"core__odometer_input_metric", (DL_FUNC) &core__odometer_input_metric, 2},
    {"core__odometer_invoke", (DL_FUNC) &core__odometer_invoke, 4},
    {"core__odometer_output_measure", (DL_FUNC) &core__odometer_output_measure, 2},
    {"core__odometer_queryable_invoke", (DL_FUNC) &core__odometer_queryable_invoke, 4},
    {"core__odometer_queryable_map", (DL_FUNC) &core__odometer_queryable_map, 4},
    {"core__queryable_eval", (DL_FUNC) &core__queryable_eval, 4},
    {"core__queryable_query_odometer_invoke_type", (DL_FUNC) &core__queryable_query_odometer_invoke_type, 2},
    {"core__queryable_query_odometer_map_type", (DL_FUNC) &core__queryable_query_odometer_map_type, 2},
    ...
    {"data__smd_curve_epsilon", (DL_FUNC) &data__smd_curve_epsilon, 3},
