...
static R_CMethodDef R_CDef[] = {
    ...
    {"combinators__make_adaptive_composition", (DL_FUNC) &combinators__make_adaptive_composition, 9},
    ...
    {"combinators__make_composition", (DL_FUNC) &combinators__make_composition, 3},
    ...
    {"combinators__make_fully_adaptive_composition", (DL_FUNC) &combinators__make_fully_adaptive_composition, 4},
    {"combinators__make_population_amplification", (DL_FUNC) &combinators__make_population_amplification, 3},
    {"combinators__make_privacy_filter", (DL_FUNC) &combinators__make_privacy_filter, 6},
    ...
    {"core__new_function", (DL_FUNC) &core__new_function, 4},
    {"core__new_queryable", (DL_FUNC) &core__new_queryable, 5},
    {"core__odometer_input_carrier_type", (DL_FUNC) &core__odometer_input_carrier_type, 2},
    ...
    {"core__odometer_queryable_invoke_type", (DL_FUNC) &core__odometer_queryable_invoke_type, 2},
    {"core__odometer_queryable_privacy_loss", (DL_FUNC) &core__odometer_queryable_privacy_loss, 4},
    {"core__odometer_queryable_privacy_loss_type", (DL_FUNC) &core__odometer_queryable_privacy_loss_type, 2},
    ...
    {"domains___extrinsic_domain_descriptor", (DL_FUNC) &domains___extrinsic_domain_descriptor, 2},
    {"domains___member", (DL_FUNC) &domains___member, 4},
    ...
    {"domains__user_domain", (DL_FUNC) &domains__user_domain, 5},
    {"domains__vector_domain", (DL_FUNC) &domains__vector_domain, 4},
    {"internal___binary_search", (DL_FUNC) &internal___binary_search, 7},
    {"internal___exponential_bounds_search", (DL_FUNC) &internal___exponential_bounds_search, 4},
    {"internal___extrinsic_distance", (DL_FUNC) &internal___extrinsic_distance, 3},
    {"internal___extrinsic_divergence", (DL_FUNC) &internal___extrinsic_divergence, 3},
    {"internal___extrinsic_domain", (DL_FUNC) &internal___extrinsic_domain, 5},
    {"internal___make_measurement", (DL_FUNC) &internal___make_measurement, 9},
    {"internal___make_transformation", (DL_FUNC) &internal___make_transformation, 9},
    {"internal___new_pure_function", (DL_FUNC) &internal___new_pure_function, 4},
    {"measurements__make_alp_queryable", (DL_FUNC) &measurements__make_alp_queryable, 12},
    {"measurements__make_canonical_noise", (DL_FUNC) &measurements__make_canonical_noise, 6},
    {"measurements__make_gaussian", (DL_FUNC) &measurements__make_gaussian, 7},
    {"measurements__make_gaussian_threshold", (DL_FUNC) &measurements__make_gaussian_threshold, 9},
    {"measurements__make_geometric", (DL_FUNC) &measurements__make_geometric, 8},
    {"measurements__make_laplace", (DL_FUNC) &measurements__make_laplace, 7},
    {"measurements__make_laplace_threshold", (DL_FUNC) &measurements__make_laplace_threshold, 9},
    {"measurements__make_noise", (DL_FUNC) &measurements__make_noise, 7},
    {"measurements__make_noise_threshold", (DL_FUNC) &measurements__make_noise_threshold, 9},
    {"measurements__make_noisy_max", (DL_FUNC) &measurements__make_noisy_max, 6},
    {"measurements__make_noisy_top_k", (DL_FUNC) &measurements__make_noisy_top_k, 7},
    {"measurements__make_private_quantile", (DL_FUNC) &measurements__make_private_quantile, 9},
    ...
    {"measurements__make_user_measurement", (DL_FUNC) &measurements__make_user_measurement, 9},
    {"measures___approximate_divergence_get_inner_measure", (DL_FUNC) &measures___approximate_divergence_get_inner_measure, 2},
    {"measures___extrinsic_measure_descriptor", (DL_FUNC) &measures___extrinsic_measure_descriptor, 2},
    ...
    {"measures__new_privacy_profile", (DL_FUNC) &measures__new_privacy_profile, 3},
    ...
    {"measures__user_divergence", (DL_FUNC) &measures__user_divergence, 3},
    {"measures__zero_concentrated_divergence", (DL_FUNC) &measures__zero_concentrated_divergence, 1},
    {"metrics___extrinsic_metric_descriptor", (DL_FUNC) &metrics___extrinsic_metric_descriptor, 2},
    ...
    {"metrics__l01inf_distance", (DL_FUNC) &metrics__l01inf_distance, 2},
    {"metrics__l02inf_distance", (DL_FUNC) &metrics__l02inf_distance, 2},
    ...
    {"metrics__user_distance", (DL_FUNC) &metrics__user_distance, 3},
    ...
    {"transformations__make_count_by", (DL_FUNC) &transformations__make_count_by, 4},
    ...
    {"transformations__make_user_transformation", (DL_FUNC) &transformations__make_user_transformation, 9},
