...
static R_CMethodDef R_CDef[] = {
    ...
    {"measurements__make_base_discrete_exponential", (DL_FUNC) &measurements__make_base_discrete_exponential, 6},
    ...
    {"metrics__linf_diff_distance", (DL_FUNC) &metrics__linf_diff_distance, 2},
