...
static R_CMethodDef R_CDef[] = {
    ...
    {"combinators__make_sequential_odometer", (DL_FUNC) &combinators__make_sequential_odometer, 4},
    ...
    {"core__odometer_queryable_map_type", (DL_FUNC) &core__odometer_queryable_map_type, 2},
