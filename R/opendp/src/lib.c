...
static R_CMethodDef R_CDef[] = {
    ...
    {"combinators__make_approximate", (DL_FUNC) &combinators__make_approximate, 2},
    ...
    {"combinators__make_fixed_approxDP_to_approxDP", (DL_FUNC) &combinators__make_fixed_approxDP_to_approxDP, 2},
    ...
    {"combinators__make_select_private_candidate", (DL_FUNC) &combinators__make_select_private_candidate, 4},
    ...
    {"data__privacy_profile_delta", (DL_FUNC) &data__privacy_profile_delta, 3},
    {"data__privacy_profile_epsilon", (DL_FUNC) &data__privacy_profile_epsilon, 3},
    {"domains___atom_domain_get_bounds_closed", (DL_FUNC) &domains___atom_domain_get_bounds_closed, 2},
    {"domains___atom_domain_nan", (DL_FUNC) &domains___atom_domain_nan, 2},
    {"domains___domain_equal", (DL_FUNC) &domains___domain_equal, 3},
    {"domains___option_domain_get_element_domain", (DL_FUNC) &domains___option_domain_get_element_domain, 2},
    {"domains___vector_domain_get_element_domain", (DL_FUNC) &domains___vector_domain_get_element_domain, 2},
    {"domains___vector_domain_get_size", (DL_FUNC) &domains___vector_domain_get_size, 2},
    {"domains__atom_domain", (DL_FUNC) &domains__atom_domain, 6},
    {"domains__bitvector_domain", (DL_FUNC) &domains__bitvector_domain, 3},
    ...
    {"measurements__debias_randomized_response_bitvec", (DL_FUNC) &measurements__debias_randomized_response_bitvec, 4},
    {"measurements__make_alp_queryable", (DL_FUNC) &measurements__make_alp_queryable, 12},
    ...
    {"measurements__make_private_quantile", (DL_FUNC) &measurements__make_private_quantile, 8},
    {"measurements__make_randomized_response", (DL_FUNC) &measurements__make_randomized_response, 5},
    {"measurements__make_randomized_response_bitvec", (DL_FUNC) &measurements__make_randomized_response_bitvec, 5},
    ...
    {"measures___measure_equal", (DL_FUNC) &measures___measure_equal, 3},
    {"measures__approximate", (DL_FUNC) &measures__approximate, 2},
    {"measures__fixed_smoothed_max_divergence", (DL_FUNC) &measures__fixed_smoothed_max_divergence, 1},
    {"measures__max_divergence", (DL_FUNC) &measures__max_divergence, 1},
    ...
    {"measures__renyi_divergence", (DL_FUNC) &measures__renyi_divergence, 1},
    {"measures__smoothed_max_divergence", (DL_FUNC) &measures__smoothed_max_divergence, 1},
    {"measures__user_divergence", (DL_FUNC) &measures__user_divergence, 2},
    {"measures__zero_concentrated_divergence", (DL_FUNC) &measures__zero_concentrated_divergence, 1},
    {"metrics___metric_equal", (DL_FUNC) &metrics___metric_equal, 3},
