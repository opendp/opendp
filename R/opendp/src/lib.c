...
static R_CMethodDef R_CDef[] = {
    ...
    {"domains__dataframe_domain", (DL_FUNC) &domains__dataframe_domain, 3},
    {"domains__dataframe_domain_with_counts", (DL_FUNC) &domains__dataframe_domain_with_counts, 3},
    ...
    {"domains__series_domain", (DL_FUNC) &domains__series_domain, 3},
    ...
    {"measurements__make_base_discrete_laplace", (DL_FUNC) &measurements__make_base_discrete_laplace, 5},
    {"measurements__make_base_discrete_laplace_cks20", (DL_FUNC) &measurements__make_base_discrete_laplace_cks20, 5},
    {"measurements__make_base_discrete_laplace_linear", (DL_FUNC) &measurements__make_base_discrete_laplace_linear, 8},
