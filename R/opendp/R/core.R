...
odometer_invoke <- function(
  ...
  # Standardize type arguments.
  .T.arg <- odometer_input_carrier_type(this)
...
odometer_queryable_invoke <- function(
  ...
  # Standardize type arguments.
  .T.query <- odometer_queryable_invoke_type(queryable)
...
odometer_queryable_privacy_loss <- function(
  ...
  # Standardize type arguments.
  .T.d_in <- odometer_queryable_privacy_loss_type(queryable)
  ...
  output <- .Call(
    ...
    queryable, d_in, rt_parse(.T.d_in),
    log_, PACKAGE = "opendp")
  output
}
