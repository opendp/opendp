...
#'
#' [`approximate` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250102.1/opendp/measures/fn.approximate.html)
#'
#' **Proof Definition:**
#'
...
approximate <- function(
  ...
  log <- new_constructor_log("approximate", "measures", new_hashtab(
    list("measure"),
    list(measure)
  ))
...
renyi_divergence <- function(
  ...
  # No type arguments to standardize.
  log <- new_constructor_log("renyi_divergence", "measures", new_hashtab(
    list(),
    list()
  ))
