...
* The **Context API** is simpler and helps to enforce best practices. Currently available only for Python, it is use in the :doc:`../../../getting-started/index` documentation.
