...
.. doctest::
    ...
    ...  f"at a statistical significance level alpha of {alpha}, "
    ...  f"or with (1 - {alpha})100% = {(1 - alpha) * 100}% confidence.")
    'When the laplace scale is 2.0000000000012452, the DP estimate differs from the true value by no more than 5.991464547111712 at a statistical significance level alpha of 0.05, or with (1 - 0.05)100% = 95.0% confidence.'
