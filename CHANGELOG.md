...
- regenerate python to include example [#1615](https://github.com/opendp/opendp/pull/1615)
- More typing on context [#1472](https://github.com/opendp/opendp/pull/1472)
- Use the same examples for `make` and `then` [#1576](https://github.com/opendp/opendp/pull/1576)
- For rust example in docs, use normal `cargo run` [#1612](https://github.com/opendp/opendp/pull/1612)
- Error if missing `arg` param on measurement in R [#1559](https://github.com/opendp/opendp/pull/1559)
- randomgen guards, again [#1562](https://github.com/opendp/opendp/pull/1562)
- Merge "then" examples into "make" and regenerate [#1575](https://github.com/opendp/opendp/pull/1575)
- speed up smoke-test [#1579](https://github.com/opendp/opendp/pull/1579)
- Polars: add `make_private_quantile_expr` [#908](https://github.com/opendp/opendp/pull/908)
- Polars: bounded-DP mean via postprocessing [#890](https://github.com/opendp/opendp/pull/890)
- Polars: add `make_expr_laplace` [#829](https://github.com/opendp/opendp/pull/829)
...
- replace datetime.now() with constant [#1561](https://github.com/opendp/opendp/pull/1561)
...
- separate builds in smoke-test to fix R/Polars CI [#1515](https://github.com/opendp/opendp/pull/1515)
- Polars: add `make_expr_sum` [#819](https://github.com/opendp/opendp/pull/819)
- Polars: add `make_expr_clip` [#868](https://github.com/opendp/opendp/pull/868)
- Move a few more rust tests to standalone files [#1548](https://github.com/opendp/opendp/pull/1548)
- Move rust tests to standalone files [#1533](https://github.com/opendp/opendp/pull/1533)
- use `--all-features` [#1526](https://github.com/opendp/opendp/pull/1526)
...
- udf -> plugin [#1528](https://github.com/opendp/opendp/pull/1528)
...
- provide specialized message if we can say what the fix is [#1511](https://github.com/opendp/opendp/pull/1511)
...
- float implies int [#1486](https://github.com/opendp/opendp/pull/1486)
- Just add a note to explain duplication [#1484](https://github.com/opendp/opendp/pull/1484)
- Polars: add `make_private_aggregate` [#847](https://github.com/opendp/opendp/pull/847)
- initial LazyFrame and Expr parsers [#1454](https://github.com/opendp/opendp/pull/1454)
- Polars: add `ExprDomain` [#795](https://github.com/opendp/opendp/pull/795)
- partition distance [#1167](https://github.com/opendp/opendp/pull/1167)
- Polars: `lazyframe_domain` ffi [#769](https://github.com/opendp/opendp/pull/769)
- Polars: `series_domain` ffi [#767](https://github.com/opendp/opendp/pull/767)
...
- delete duplicate def [#1475](https://github.com/opendp/opendp/pull/1475)
...
- For generate_header def and use, ffi -> bindings [#1434](https://github.com/opendp/opendp/pull/1434)
...
- More R linting (rebased) [#1408](https://github.com/opendp/opendp/pull/1408)
- use appropriate shell syntax [#1406](https://github.com/opendp/opendp/pull/1406)
...
- Fix erratic R linting errors, hopefully [#1402](https://github.com/opendp/opendp/pull/1402)
...
- Fix nightly [#1350](https://github.com/opendp/opendp/pull/1350)
...
- R linting [#1344](https://github.com/opendp/opendp/pull/1344)
...
- A concept on every R function [#1299](https://github.com/opendp/opendp/pull/1299)
...
- no more bare excepts [#1303](https://github.com/opendp/opendp/pull/1303)
...
- reverse ternary, so it is not confused by false-y empty string [#1249](https://github.com/opendp/opendp/pull/1249)
- fix unneeded f-strings; stricter linting [#1217](https://github.com/opendp/opendp/pull/1217)
- remove reference to poly [#1226](https://github.com/opendp/opendp/pull/1226)
