...
use crate::ffi::any::{AnyDomain, AnyMeasurement, AnyObject, AnyQueryable, Downcast};
use crate::ffi::util::{self, into_c_char_p, into_raw, to_str, AnyDomainPtr, ExtrinsicObject};
...
pub extern "C" fn opendp_data__object_as_slice(obj: *const AnyObject) -> FfiResult<*mut FfiSlice> {
    ...
    fn _series_to_raw(series: &Series) -> Fallible<FfiSlice> {
        ...
        // https://github.com/pola-rs/pyo3-polars/blob/main/pyo3-polars/src/lib.rs#L163
