...
use crate::core::{
    Domain, Function, HintMt, HintTt, Measure, Measurement, Metric, PrivacyRelation,
...
where
    ...
    MTO: 'static + Metric,
{
    if measurement0.output_domain != transformation1.input_domain {
        return fallible!(
            DomainMismatch,
            mismatch_message(
                "domain",
    ...
    Ok(Measurement::new(
        ...
        measurement0.privacy_relation.clone(),
    ))
}

pub fn make_basic_composition<DI, DO0, DO1, MI, MO>(
    ...
    MO: 'static + Measure,
{
    ...
    Ok(Measurement::new(
        measurement0.input_domain.clone(),
        PairDomain::new(
            measurement0.output_domain.clone(),
            measurement1.output_domain.clone(),
        ),
