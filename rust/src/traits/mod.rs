...
/// test_func(1i8);
/// ```
pub trait Primitive: 'static + Clone + std::fmt::Debug + CheckNull + PartialEq + Default + CheckAtom {}
impl<T> Primitive for T where T: 'static + Clone + std::fmt::Debug + CheckNull + PartialEq + Default + CheckAtom {}
