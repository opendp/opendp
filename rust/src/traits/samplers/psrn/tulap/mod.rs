...
impl TulapDist {
    pub fn new_psrn(shift: RBig, epsilon: FBig, delta: RBig) -> Fallible<PSRN<Self>> {
        // exp(ε)
...
#[proven(proof_path = "traits/samplers/psrn/tulap/PSRN.tex")]
impl InverseCDF for TulapDist {
    type Edge = RBig;
