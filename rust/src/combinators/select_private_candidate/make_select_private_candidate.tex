...
This constructor is a special case of \rustdoc{combinators/fn}{make\_select\_private\_candidate}.
The proof for this constructor appeals to the proof for \rustdoc{combinators/fn}{make\_select\_private\_candidate}.
...
\validMeasurement{\texttt{(measurement, stop\_probability, threshold, max\_iterations, DI, MI, TO)}}{\texttt{make\_select\_private\_candidate}}
