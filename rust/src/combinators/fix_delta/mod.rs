use crate::{
    ...
    error::Fallible,
    measures::{Approximate, PrivacyProfile, ProfileDP, PureDP, curves::logspace::check_delta},
    traits::CInterval,
};
...
/// Fix the delta parameter in the privacy map of a `measurement` with a `ProfileDP` output measure.
///
/// # Arguments
...
/// * `DI` - Input Domain
/// * `MI` - Input Metric.
/// * `MO` - Output Measure of the input argument. Must be `ProfileDP`
/// * `TO` - Output Type
...
impl FixDeltaMeasure for ProfileDP {
...
impl FixDeltaMeasure for Approximate<ProfileDP> {
    type FixedMeasure = Approximate<PureDP>;
