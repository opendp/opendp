...
\begin{theorem}
  ...
  where each \texttt{d\_mid} is charged \texttt{k} times,
...
\begin{proof}
  ...
  By the postconditions of \rustdoc{traits/trait}{InfAdd} and \rustdoc{traits/trait}{InfMul} we have that for any choice of \texttt{alpha}, $\sum_i k_i \texttt{d\_mid}_i(\texttt{alpha}) \le \texttt{compose(d\_mids)}(\alpha)$.
