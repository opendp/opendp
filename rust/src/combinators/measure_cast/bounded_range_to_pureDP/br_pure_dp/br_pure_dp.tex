...
\contrib
Proves soundness of \texttt{fn bounded\_range\_to\_pureDP} in \asOfCommit{mod.rs}{0b8f4222}.
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/br_pure_dp.py}
