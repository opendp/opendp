...
% Based on this proof:
% https://arxiv.org/pdf/2004.00010.pdf#subsection.2.3

% To close this issue:
% https://github.com/opendp/opendp/issues/524

% Implementation:
% https://github.com/opendp/opendp/blob/504-zcdp-smd-cast/rust/src/comb/measure_cast/zCDP_to_approxDP/cks20.rs
