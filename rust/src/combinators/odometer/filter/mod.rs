...
use super::CompositionOdometerQueryable;
...
pub fn make_odometer_to_filter<
    ...
    MO: 'static + Measure,
>(
    odometer: Odometer<DI, CompositionOdometerQueryable<DI, TO, MI, MO>, MI, MO>,
    d_in: MI::Distance,
    d_out: MO::Distance,
) -> Fallible<Measurement<DI, CompositionOdometerQueryable<DI, TO, MI, MO>, MI, MO>>
where
