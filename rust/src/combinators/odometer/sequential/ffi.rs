...
fn make_composition_odometer(
    ...
    let compositor: Odometer<
        ...
        _,
        _,
    > = super::make_composition_odometer(input_domain, input_metric, output_measure)?;
...
#[no_mangle]
pub extern "C" fn opendp_combinators__make_composition_odometer(
    ...
    make_composition_odometer(input_domain, input_metric, output_measure).into()
}
