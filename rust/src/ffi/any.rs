...
use crate::core::{
    ...
    MetricSpace, Odometer, OdometerQuery, OdometerQueryable, PrivacyMap, StabilityMap,
    Transformation,
};
use crate::error::*;
...
impl<Q: 'static + Clone> Odometer<AnyDomain, AnyMetric, AnyMeasure, Q, AnyObject> {
    pub fn into_any_Q(self) -> AnyOdometer {
        let function = self.function.clone();
...
pub type AnyOdometerQueryable = OdometerQueryable<AnyMetric, AnyMeasure, AnyObject, AnyObject>;
