...
use crate::dist::{ChangeOneDistance, L1Distance, L2Distance, SymmetricDistance, AbsoluteDistance, MaxDivergence, SmoothedMaxDivergence};
use crate::error::*;
...
lazy_static! {
    ...
    static ref TYPES: Vec<Type> = {
        let types: Vec<Type> = vec![
            ...
            // metrics
            type_vec![ChangeOneDistance, SymmetricDistance],
