...
macro_rules! disp_expand {
    ...
    ($function:ident, ($rt_type:expr, @numbers_plus),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [u32, u64, i32, i64, usize, f32, f64, ExtrinsicObject]), $rt_dispatch_types, $type_args, $args)
    };
...
macro_rules! disp_expand {
    ...
    ($function:ident, ($rt_type:expr, @numbers_plus),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [u32, i32, f64, ExtrinsicObject]), $rt_dispatch_types, $type_args, $args)
    };
    ($function:ident, ($rt_type:expr, @hashable),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
