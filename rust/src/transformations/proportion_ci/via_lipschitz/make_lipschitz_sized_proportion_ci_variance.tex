...
% in lines 28-53 of the file \texttt{mod.rs}
...
\begin{enumerate}
    ...
    \begin{equation*}
        \begin{aligned}
            ...
            & = \sum_{i} c_i^2  \cdot \frac{N_i - n_i}{N_i(n_i -1)} \cdot \left| \frac{v_i - w_i}{n_i} \left(1 - \frac{v_i + w_i}{n_i}\right) \right|\\ %\textrm{By Eq.~\ref{ineq} and the triangle ineq.}
