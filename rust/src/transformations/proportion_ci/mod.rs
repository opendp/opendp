...
use crate::{
    core::{Function, Postprocessor, StabilityMap, Transformation},
    domains::{AllDomain, ProductDomain, VectorDomain},
...
> {
    ...
    Ok(Transformation::new(
        ProductDomain::new(vec![AllDomain::new(); sample_sizes.len()]),
        AllDomain::new(),
        Function::new(move |sample_sums: &Vec<TA>| {
            (sample_sums.iter())
                .zip(sample_sizes.iter())
