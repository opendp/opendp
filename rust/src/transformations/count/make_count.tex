...
\begin{proof} \textbf{(Part 2 -- domain-metric compatibility).}
    ...
    Our \texttt{output\_metric} of \rustdoc{metrics/struct}{AbsoluteDistance} is compatible with any domain of the form \texttt{AtomDomain(T)} where \texttt{T} has the trait \texttt{InfSub}, 
