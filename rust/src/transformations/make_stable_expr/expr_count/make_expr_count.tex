...
This document proves that the implementation of \rustdoc{transformations/make_stable_expr/expr_count/fn}{make\_count\_expr} in \asOfCommit{mod.rs}{f5bb719} 
...
\validTransformation{(input\_domain, input\_metric, MI, P)}{make\_expr\_count}
...
\begin{proof}
    \textbf{Count Transformation Appropriate Output Domain}
...
\begin{proof}
    \textbf{Count Transformation Stability Guarantee}
