...
\contrib
Proves soundness of \rustdoc{transformations/make\_stable\_expr/expr\_str/expr\_strptime/fn}{make\_stable\_strptime} in \asOfCommit{mod.rs}{f5bb719}.
...
\validTransformation{\texttt{(input\_domain, input\_metric, M)}}{\texttt{make\_expr\_strptime}}
