...
\begin{itemize} 
    \item Generic \texttt{DI} (input domain) is a type with trait \rustdoc{transformations/trait}{RowByRowDomain}\texttt{<DO>}.  
    \item Generic \texttt{DO} (output domain) is a type with trait \rustdoc{transformations/trait}{DatasetDomain}.  
        \texttt{DatasetDomain} is used to define the type of the row domain. 
    \item Generic \texttt{M} (metric) is a type with trait \rustdoc{transformations/trait}{DatasetMetric}.  
    ...
    \item Argument \texttt{output\_row\_domain} is of type \texttt{DI::ElementDomain}, as defined by \rustdoc{transformations/trait}{DatasetDomain}. 
...
\validTransformation{\texttt{(input\_domain, input\_metric, output\_row\_domain, outprow\_function, DI, DO, M)}}{\texttt{make\_row\_by\_row}} 
