...
use crate::error::*;
use crate::metrics::{
    Bound, Bounds, DatabaseIdDistance, FrameDistance, PolarsMetric, SymmetricIdDistance,
    unique_id_expr,
};
use polars::prelude::*;
...
> {
    ...
    let active_id = unique_id_expr(&output_metric.0.active_id_sites())?;
