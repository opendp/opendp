...
use crate::{
    ...
    ffi::util::Type,
    meas::{make_base_discrete_laplace_cks20, DiscreteLaplaceDomain},
    traits::InfCast,
};
...
#[no_mangle]
pub extern "C" fn opendp_meas__make_base_discrete_laplace_cks20(
    scale: *const c_void,
    D: *const c_char,
    QO: *const c_char,
...
mod tests {
    ...
    fn test_make_base_discrete_laplace_cks20_ffi() -> Fallible<()> {
        let measurement = Result::from(opendp_meas__make_base_discrete_laplace_cks20(
