...
pub fn make_alp_state_with_hashers<K, CI>(
    ...
    input_metric: PartitionDistance<AbsoluteDistance<CI>>,
    scale: f64,
    alpha: f64,
    ...
    Measurement<
        SparseDomain<K, CI>,
        AlpState<K>,
        PartitionDistance<AbsoluteDistance<CI>>,
        MaxDivergence,
    >,
>
where
    ...
    f64: InfCast<CI>,
    (SparseDomain<K, CI>, PartitionDistance<AbsoluteDistance<CI>>): MetricSpace,
{
