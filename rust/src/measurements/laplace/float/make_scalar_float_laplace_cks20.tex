...
\begin{tcolorbox}
    ...
    \begin{lemma}
        \rustdoc{measurements/laplace/float/fn}{get\_discretization\_consts}, 
        \rustdoc{traits/samplers/discretize/fn}{sample\_discrete\_laplace\_Z2k} and 
        \rustdoc{measurements/laplace/fn}{laplace\_puredp\_map} each satisfy their postcondition.
    \end{lemma}
\end{tcolorbox}
