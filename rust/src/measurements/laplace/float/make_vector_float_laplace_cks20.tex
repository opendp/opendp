...
Proves soundness of \rustdoc{measurements/fn}{make\_vector\_float\_laplace\_cks20} in \asOfCommit{mod.rs}{f5bb719}.
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/make_vector_float_laplace_cks20.py}

\subsection*{Postcondition}

\validMeasurement{\texttt{(input\_domain, input\_metric, scale, k, T)}}{\\\texttt{make\_vector\_float\_laplace\_cks20}}
