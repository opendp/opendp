...
\begin{itemize}
    ...
    \item Generic \texttt{T} must have trait \rustdoc{traits/trait}{Integer} and support saturating cast from \texttt{IBig} (for postprocessing a noisy big integer back to \texttt{T})
...
\validMeasurement{\texttt{(input\_domain, input\_metric, scale, T)}}{\\\texttt{make\_vector\_integer\_laplace}}
