...
\begin{proof}[Proof for \ref{postcondition} Privacy Guarantee]
    ...
    then the preconditions for \rustdoc{measurements/make\_report\_noisy\_top\_k/trait}{SelectionMeasure}\texttt{.privacy_map} on line \ref{fn-privacy-map-call} are met.
