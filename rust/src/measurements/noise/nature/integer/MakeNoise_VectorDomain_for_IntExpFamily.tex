...
\begin{proof}
    ...
    Neither constructor \rustdoc{measurements/nature/integer/fn}{make\_int\_to\_bigint} nor
    ...
    \rustdoc{measurements/nature/integer/fn}{then\_saturating\_cast} also does not have preconditions,
