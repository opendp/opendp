...
\begin{theorem}
    \validTransformation{(\texttt{T})}{\texttt{make\_float\_to\_bigint}}
\end{theorem}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        This increase in the sensitivity is reflected in on line \ref{line:x-div-2k},
        ...
        \item The discarding of the denominator on line \ref{line:find-nearest} is $2^k$-stable,
            ...
            where the sensitivity is increased by a factor of $2^k$.
    \end{itemize}
