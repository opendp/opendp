...
\begin{proof}
    ...
    Neither constructor \rustdoc{measurements/nature/float/fn}{make\_float\_to\_bigint} nor
    ...
    \rustdoc{measurements/nature/float/fn}{then\_deintegerize\_vec} also does not have preconditions,
