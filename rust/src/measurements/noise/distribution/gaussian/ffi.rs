...
use crate::measurements::{make_gaussian, Gaussian, MakeNoise};
...
pub extern "C" fn opendp_measurements__make_gaussian(
    ...
    fn monomorphize<MO: 'static + Measure, T: 'static + Number + Nature<2>, QI: 'static + Number>(
            ...
            + MakeNoise<VectorDomain<AtomDomain<T>>, L2Distance<QI>, MO>,
    {
        ...
        where
            MI: GaussianMetric<T>,
            Gaussian: MakeNoise<MI::Domain, MI, MO>,
