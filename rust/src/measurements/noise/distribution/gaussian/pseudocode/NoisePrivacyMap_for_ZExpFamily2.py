# type: ignore
# analogous to impl NoisePrivacyMap<L2Distance<RBig>, zCDP> for ZExpFamily<1> in Rust
class ZExpFamily2:
    def noise_privacy_map(
        self, _input_metric: L2Distance[RBig], _output_measure: zCDP
    ) -> PrivacyMap[L2Distance[RBig], zCDP]:
        scale = self.scale
