...
\contrib
Proves soundness of the implementation of \rustdoc{measurements/noise/distribution/gaussian/fn}{make\_gaussian} in \asOfCommit{mod.rs}{f5bb719}.
...
\begin{itemize}
    ...
    \item type \texttt{DI\_Atom\_RV2} (the random variable associated with the atom data type) implements trait \rustdoc{measurements/noise/trait}{MakeNoise}\texttt{<DI, MI, MO>}
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/make_gaussian.py}

\subsection*{Postcondition}
\begin{theorem}
    \validMeasurement{(\texttt{input\_domain, input\_metric, scale, k, DI, MI, MO})}{\texttt{make\_gaussian}}
\end{theorem}
