...
\begin{itemize}
    ...
    \item type \texttt{Gaussian} implements trait \rustdoc{measurements/noise/trait}{MakeNoise}\texttt{<DI, MI, MO>}
...
\begin{proof}
    We first construct a random variable \rustdoc{measurements/noise/distribution/gaussian/struct}{Gaussian} representing the desired noise distribution.
