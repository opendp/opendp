...
\title{\texttt{MakeNoise<DI, MI, MO> for Gaussian}}
...
for \texttt{Gaussian} in \asOfCommit{mod.rs}{f5bb719}.
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/MakeNoise_for_Gaussian.py}
