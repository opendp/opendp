...
\title{\texttt{MakeNoise<DI, MI, MO> for Laplace}}
...
for \texttt{Laplace} in \asOfCommit{mod.rs}{f5bb719}.
...
\begin{itemize}
    ...
    \item \texttt{DI\_Atom\_RV1} implements trait \rustdoc{measurements/noise/trait}{MakeNoise}.
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/MakeNoise_for_Laplace.py}
