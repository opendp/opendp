...
\begin{itemize}
    ...
    \item type \texttt{Laplace} implements trait \rustdoc{measurements/noise/trait}{MakeNoise}\texttt{<DI, MI, MO>}
...
\begin{proof}
    We first construct a random variable \rustdoc{measurements/noise/distribution/laplace/struct}{Laplace} representing the desired noise distribution.
