...
use crate::measurements::{make_geometric, ConstantTimeGeometric, Laplace, MakeNoise, NoiseDomain};
...
pub extern "C" fn opendp_measurements__make_geometric(
    ...
    fn monomorphize<MO: 'static + Measure, T: 'static + Integer + Nature<1>, QI: 'static + Number>(
    ...
    where
        T::RV: MakeNoise<AtomDomain<T>, AbsoluteDistance<QI>, MO>
            ...
            + MakeNoise<VectorDomain<AtomDomain<T>>, L1Distance<QI>, MO>,
    {
        ...
        where
            ...
            Laplace: MakeNoise<MI::Domain, MI, MO>,
