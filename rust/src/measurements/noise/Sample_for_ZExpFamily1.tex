...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/Sample_for_ZExpFamily1.py}
...
\begin{proof}
    ...
    Since the preconditions for \rustdoc{traits/samplers/cks20/sample\_discrete\_laplace} are met (non-negative scale),
