...
/// Make a Measurement that takes a vector of scores and sanitarily selects the index of the highest score.
///
/// # Arguments
...
/// * `optimize` - Indicate whether to sanitarily return the "max" or "min"
///
/// # Generics
