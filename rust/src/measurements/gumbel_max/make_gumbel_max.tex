...
\lstinputlisting[language=Python,firstline=2]{./pseudocode/make_gumbel_max.py}

\subsection*{Postcondition}

\validMeasurement{\texttt{input\_domain, input\_metric, temperature, optimize, TIA, QO}}{\texttt{make\_base\_discrete\_exponential}} 
...
Assume $u$, $v$ in \texttt{input\_domain} are \din-close under \rustdoc{metrics/struct}{RangeDistance} and $\texttt{privacy\_map}(\din) \le \dout$.
