...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/top.py} 
...
\begin{proof}
    ...
    the precondition for \rustdoc{measurements/report\_noisy\_top\_k/fn}{partition\_point\_mut} is satisfied.
    Since the preconditions for \rustdoc{measurements/report\_noisy\_top\_k/fn}{partition\_point\_mut} are met,
