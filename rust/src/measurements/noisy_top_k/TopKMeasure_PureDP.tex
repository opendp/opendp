...
\title{\texttt{impl TopKMeasure for PureDP}}
\author{\TudorCebereAuthor \and \MichaelShoemateAuthor}
\begin{document}
\maketitle
\contrib

This document proves soundness of \rustdoc{measurements/noisy_top_k/trait}{TopKMeasure} for \texttt{PureDP} in \asOfCommit{mod.rs}{e62b0aa2}.
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/TopKMeasure_PureDP.py}
