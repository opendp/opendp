...
\begin{proof}
    ...
    \begin{itemize}
        ...
        This increase in the sensitivity is reflected on lines \ref{line:lp-x-div-2k} and \ref{line:li-x-div-2k},
        where the rounding distance is added to the $L_p$ and $L_\infty$ sensitivities.

        \item The discarding of the denominator on line \ref{line:find-nearest} is $2^k$-stable,
            as the denominator is $2^k$.
            This increase in sensitivity is also reflected on lines \ref{line:lp-x-div-2k} and \ref{line:li-x-div-2k},
