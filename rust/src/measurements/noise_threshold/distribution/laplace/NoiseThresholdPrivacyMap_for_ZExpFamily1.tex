...
\title{\texttt{NoiseThresholdPrivacyMap<L01InfDistance<AbsoluteDistance<RBig>>, Approximate<PureDP>> for ZExpFamily<1>}}
...
\begin{itemize}
    ...
    \item \texttt{MO}, the output measure, is of type \rustdoc{measures/struct}{Approximate}\texttt{<PureDP>}
\end{itemize}
