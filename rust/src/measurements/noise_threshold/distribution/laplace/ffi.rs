...
use crate::ffi::util::{as_ref, Type, TypeContents};
use crate::measurements::nature::Nature;
use crate::measurements::{make_laplace_threshold, MakeNoiseThreshold};
...
pub extern "C" fn opendp_measurements__make_laplace_threshold(
    ...
    fn monomorphize<MO: 'static + Measure, TK, TV>(
    ...
    where
        TK: Hashable,
        TV: Number + Nature<1>,
        <TV as Nature<1>>::RV: MakeNoiseThreshold<
            MapDomain<AtomDomain<TK>, AtomDomain<TV>>,
            PartitionDistance<AbsoluteDistance<TV>>,
            MO,
            Threshold = TV,
        >,
    {
        ...
        let input_metric = input_metric
            .downcast_ref::<PartitionDistance<AbsoluteDistance<TV>>>()?
            .clone();
