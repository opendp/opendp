...
\title{\texttt{NoiseThresholdPrivacyMap<L02I<AbsoluteDistance<UBig>>, Approximate<zCDP>> for ZExpFamily<2>}}
...
\contrib
Proves soundness of the implementation of \rustdoc{measurements/noise_threshold/trait}{NoiseThresholdPrivacyMap} for \texttt{ZExpFamily<2>} in \asOfCommit{mod.rs}{f5bb719}.
...
\begin{itemize}
    ...
    \item \texttt{MO}, the output measure, is of type \rustdoc{measures/struct}{Approximate}\texttt{<zCDP>}
\end{itemize}
...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/NoiseThresholdPrivacyMap_for_ZExpFamily2.py}
...
\begin{proof}
    ...
    By the postcondition of \\ \rustdoc{accuracy/tail_bounds/fn}{conservative\_discrete\_gaussian\_tail\_to\_alpha},
