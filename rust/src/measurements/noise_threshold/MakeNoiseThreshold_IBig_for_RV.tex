...
\begin{itemize}
    ...
    \item Type \texttt{ZExpFamily<P>} implements trait \rustdoc{measurements/noise_threshold/trait}{NoiseThresholdPrivacyMap}\texttt{<L0PI<P, AbsoluteDistance<UBig>{}>, MO>}
\end{itemize}
