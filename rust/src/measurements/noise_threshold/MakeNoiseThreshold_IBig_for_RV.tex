...
\contrib
Proves soundness of the implementation of \rustdoc{measurements/noise/trait}{MakeNoiseThreshold} 
...
\begin{itemize}
    ...
    \item Type \texttt{ZExpFamily<P>} implements trait \rustdoc{measurements/noise\_threshold/trait}{NoiseThresholdPrivacyMap}\texttt{<L0PI<P, AbsoluteDistance<UBig>{}>, MO>}
\end{itemize}
...
\begin{theorem}
    \validMeasurement{(\texttt{self, input\_space, threshold, MO, TK, P})}{\texttt{make\_noise}}
\end{theorem}
