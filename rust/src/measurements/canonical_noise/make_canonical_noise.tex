...
\begin{itemize}
    ...
    \item Argument \texttt{d\_out} of type \texttt{PrivacyCurve}.
\end{itemize}
...
\texttt{d\_out} is passed in directly as a \texttt{PrivacyCurve}, which defines the tradeoff function via evaluation.
