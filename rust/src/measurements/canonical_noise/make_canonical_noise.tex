...
\begin{itemize}
    ...
    \item Argument \texttt{d\_out} of type \texttt{TradeoffCurve}.
\end{itemize}
...
\texttt{d\_out} is passed in directly as a \texttt{TradeoffCurve}, which defines the tradeoff function via evaluation.
...
Since \texttt{tradeoff} is an equivalent representation of the privacy parameters \texttt{d\_out},
the mechanism satisfies \texttt{d\_out}-DP when input datasets differ by exactly \texttt{d\_in}.
