...
\lstinputlisting[language=Python,firstline=2,escapechar=|]{./pseudocode/make_tulap.py}
...
\rustdoc{traits/samplers/struct}{PartialSample}\texttt{.value}, hereafter referred to as just \texttt{value} (a function) 
