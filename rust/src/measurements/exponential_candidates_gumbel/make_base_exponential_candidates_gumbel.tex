...
Proves soundness of \rustdoc{measurements/fn}{make\_base\_exponential\_candidates\_gumbel} 
...
\lstinputlisting[language=Python,firstline=2]{./pseudocode/make_base_exponential_candidates_gumbel.py}

\subsection*{Postcondition}

\validMeasurement{\texttt{temperature}}{\texttt{make\_base\_exponential\_candidates\_gumbel}} 
...
A floating-point safe implementation is pending in \vettingPR{653}.
