...
use crate::core::{DatasetMetric, Domain, Metric, SensitivityMetric, StabilityRelation, Transformation};
...
pub trait MakeTransformation0<DI: Domain, DO: Domain, MI: Metric, MO: Metric> {
    fn make() -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error> {
        Self::make0()
    }
    fn make0() -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error>;
}

pub trait MakeTransformation1<DI: Domain, DO: Domain, MI: Metric, MO: Metric, P1> {
    fn make(param1: P1) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error> {
        Self::make1(param1)
    }
    fn make1(param1: P1) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error>;
}

pub trait MakeTransformation2<DI: Domain, DO: Domain, MI: Metric, MO: Metric, P1, P2> {
    fn make(param1: P1, param2: P2) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error> {
        Self::make2(param1, param2)
    }
    fn make2(param1: P1, param2: P2) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error>;
}

pub trait MakeTransformation3<DI: Domain, DO: Domain, MI: Metric, MO: Metric, P1, P2, P3> {
    fn make(param1: P1, param2: P2, param3: P3) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error> {
        Self::make3(param1, param2, param3)
    }
    fn make3(param1: P1, param2: P2, param3: P3) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error>;
}

pub trait MakeTransformation4<DI: Domain, DO: Domain, MI: Metric, MO: Metric, P1, P2, P3, P4> {
    fn make(param1: P1, param2: P2, param3: P3, param4: P4) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error> {
        Self::make4(param1, param2, param3, param4)
    }
    fn make4(param1: P1, param2: P2, param3: P3, param4: P4) -> Result<crate::core::Transformation<DI, DO, MI, MO>, Error>;
}
...
impl<D, T, M, Q> MakeTransformation2<D, D, M, M, D, M> for Identity
    ...
    fn make2(domain: D, metric: M) -> Result<Transformation<D, D, M, M>, Error> {
...
impl<M, T> MakeTransformation2<VectorDomain<AllDomain<T>>, VectorDomain<IntervalDomain<T>>, M, M, T, T> for Clamp<M, T>
    ...
    fn make2(lower: T, upper: T) -> Result<Transformation<VectorDomain<AllDomain<T>>, VectorDomain<IntervalDomain<T>>, M, M>, Error> {
        Ok(Transformation::new(
            VectorDomain::new_all(),
            VectorDomain::new(IntervalDomain::new(Bound::Included(lower), Bound::Included(upper))),
            move |arg: &Vec<T>| clamp(lower, upper, arg),
            M::new(),
            M::new(),
...
impl<MO, T> MakeTransformation2<VectorDomain<IntervalDomain<T>>, AllDomain<T>, HammingDistance, MO, T, T> for BoundedSum<HammingDistance, MO, T>
    ...
    fn make2(lower: T, upper: T) -> Result<Transformation<VectorDomain<IntervalDomain<T>>, AllDomain<T>, HammingDistance, MO>, Error> {
...
impl<MO, T> MakeTransformation2<VectorDomain<IntervalDomain<T>>, AllDomain<T>, SymmetricDistance, MO, T, T> for BoundedSum<SymmetricDistance, MO, T>
    ...
    fn make2(lower: T, upper: T) -> Result<Transformation<VectorDomain<IntervalDomain<T>>, AllDomain<T>, SymmetricDistance, MO>, Error> {
        if lower > upper { return Err(Error::MakeTransformation("lower bound may not be greater than upper bound".to_string())) }
...
impl<MO, T> MakeTransformation3<SizedDomain<VectorDomain<IntervalDomain<T>>>, AllDomain<T>, SymmetricDistance, MO, usize, T, T> for BoundedSum<SymmetricDistance, MO, T>
    ...
    fn make3(length: usize, lower: T, upper: T) -> Result<Transformation<SizedDomain<VectorDomain<IntervalDomain<T>>>, AllDomain<T>, SymmetricDistance, MO>, Error> {
        if lower > upper { return Err(Error::MakeTransformation("lower bound may not be greater than upper bound".to_string())) }
...
impl<MI, MO, T> MakeTransformation0<VectorDomain<AllDomain<T>>, AllDomain<u32>, MI, MO> for Count<MI, MO, T>
    ...
    fn make0() -> Result<Transformation<VectorDomain<AllDomain<T>>, AllDomain<u32>, MI, MO>, Error> {
        Ok(Transformation::new(
            VectorDomain::new_all(),
            AllDomain::new(),
