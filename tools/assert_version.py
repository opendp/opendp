...
from utils import get_python_version, get_r_version, get_version
...
assert version.prerelease is None or "dev" not in version.prerelease, (
    "Please configure the channel with a non-dev version."
)
